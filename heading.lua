...
--Setup - memory chip with following variables x,y,z,tx,ty,tz,td,t_angl
...
mx=:x-px my=:y-py mz=:z-pz tdx=:tx-:x tdy=:ty-:y tdz=:tz-:z
px=:x py=:y pz=:z l=sqrt(tdx^2+tdy^2+tdz^2) //test direction td vector
